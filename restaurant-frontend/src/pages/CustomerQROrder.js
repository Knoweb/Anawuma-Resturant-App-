  ...
  const AnnouncementBar = () => (
    <div className="announcement-bar">
      <div className="announcement-marquee">
        <span>WELCOME TO ANAWUMA - WHERE EVERY MEAL IS A CELEBRATION | ORDER VIA QR FOR INSTANT SERVICE | 10% DISCOUNT ON YOUR FIRST ORDER | FRESH INGREDIENTS & AUTHENTIC TASTE | VISIT US FOR A PREMIUM DINING EXPERIENCE</span>
        <span>WELCOME TO ANAWUMA - WHERE EVERY MEAL IS A CELEBRATION | ORDER VIA QR FOR INSTANT SERVICE | 10% DISCOUNT ON YOUR FIRST ORDER | FRESH INGREDIENTS & AUTHENTIC TASTE | VISIT US FOR A PREMIUM DINING EXPERIENCE</span>
      </div>
    </div>
  );
